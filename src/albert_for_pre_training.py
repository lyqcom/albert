...
class GetMaskedLMOutput(nn.Cell):
    ...
    def construct(self,
        ...
        # transformer模型中取出最后一层的输出中的对应被MASK的词向量
        ...
        # 将其与embedding table中每个词向量求点积获得和每个词的相似度
...
class GetSentenceOrderOutput(nn.Cell):
    """
    ...
    def __init__(self, config):
        super(GetSentenceOrderOutput, self).__init__()
...
class AlbertPreTraining(nn.Cell):
    ...
    def __init__(self, config, is_training, use_one_hot_embeddings):
        ...
        self.cls2 = GetSentenceOrderOutput(config)
