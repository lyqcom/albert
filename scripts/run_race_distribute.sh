...
echo "bash scripts/run_race_distribute.sh"
echo "for example: bash scripts/run_race_distribute.sh"
echo "=============================================================================================================="
...
mpirun -n $RANK_SIZE python ${PROJECT_DIR}/../run_race.py  \
    ...
    --vocab_file_path="./moveckpt/30k-clean.vocab" > ./output/logs/race_dis.log 2>&1 &
