...
echo "bash scripts/run_squad_v2_distribute.sh"
echo "for example: bash scripts/run_squad_v2_distribute.sh"
echo "=============================================================================================================="
...
mpirun -n $RANK_SIZE python ${PROJECT_DIR}/../run_squad_v2.py  \
