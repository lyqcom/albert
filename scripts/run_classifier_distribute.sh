...
echo "for example: bash scripts/run_classifier_distribute.sh 2"
echo "=============================================================================================================="
...
mpirun -n $RANK_SIZE python ${PROJECT_DIR}/../run_classifier.py  \
    ...
    --vocab_file_path="./moveckpt/30k-clean.vocab" > ./output/logs/classifier_dis.log 2>&1 &
