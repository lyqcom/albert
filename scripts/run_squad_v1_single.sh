...
echo "bash scripts/run_squad_v1_single.sh"
echo "for example: bash scripts/run_squad_v1_single.sh"
echo "=============================================================================================================="
...
python ${PROJECT_DIR}/../run_squad_v1.py  \
    ...
    --load_finetune_checkpoint_path="./output/squad_finetune/"  > ./output/logs/squad_v1.log 2>&1 &
